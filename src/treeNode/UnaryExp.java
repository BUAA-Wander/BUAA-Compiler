...
public class UnaryExp extends TreeNode {
    ...
    public String outputAdaptToHomework() {
        ...
        if (type == UnaryExpType.PRIMARY) {
            builder.append(primaryExp.outputAdaptToHomework()).append("\n");
            ...
            if (funcRParams != null) {
                builder.append(funcRParams.outputAdaptToHomework()).append("\n");
            }
            builder.append(rightParent.outputAdaptToHomework()).append("\n");
        } else {
            builder.append(unaryOp.outputAdaptToHomework()).append("\n");
            builder.append(unaryExp.outputAdaptToHomework()).append("\n");
        }
        builder.append("<UnaryExp>");
...
//                                  List<Error> errors) {
//        if (type == UnaryExpType.PRIMARY) {
//            primaryExp.createSymbolTable(level, symbolTable, errors);
//        } else if (type == UnaryExpType.FUNCCALL) {
//            if (!dealWithErrorC(symbolTable, errors)) {
//                return;
//            }
//            dealWithErrorD(symbolTable, errors);
//            dealWithErrorE(symbolTable, errors);
//
//            if (funcRParams != null) {
//                funcRParams.createSymbolTable(level, symbolTable, errors);
//            }
//        } else {
//            unaryExp.createSymbolTable(level, symbolTable, errors);
//        }
//    }

//    public void dealWithErrorD(SymbolTable symbolTable, List<Error> errors) {
//        SymbolTableItem item = symbolTable.getItem(ident.getName(), SymbolType.FUNC);
//        if (item.getSymbolType() == SymbolType.FUNC) {
//            Symbol symbol = item.getSymbol();
//            if (symbol instanceof FuncSymbol) {
//                int count = ((FuncSymbol) symbol).getParamCount();
//                if (funcRParams != null) {
//                    if (count != funcRParams.getParamCount()) {
//                        errors.add(new Error(ident.getLineNumber(), "d"));
//                    }
//                } else {
//                    if (count != 0) {
//                        errors.add(new Error(ident.getLineNumber(), "d"));
...
//    public void dealWithErrorE(SymbolTable symbolTable, List<Error> errors) {
//        SymbolTableItem item = symbolTable.getItem(ident.getName(), SymbolType.FUNC);
//        Symbol symbol = item.getSymbol();
//        if (symbol instanceof FuncSymbol) {
//            FuncSymbol funcSymbol = ((FuncSymbol) symbol);
//            List<ParamType> funcDefParamTypes = funcSymbol.getParamTypes();
//            List<ParamType> funcCallParamTypes = new ArrayList<>();
//            if (funcRParams != null) {
//                funcCallParamTypes = funcRParams.getParamTypes(symbolTable);
//            }
//            int funcDefParamCount = 0;
//            int funcCallParamCount = 0;
//            if (funcCallParamTypes != null) {
//                funcCallParamCount = funcCallParamTypes.size();
//            }
//            if (funcDefParamTypes != null) {
//                funcDefParamCount = funcDefParamTypes.size();
//            }
//            if (funcCallParamCount == funcDefParamCount) {
//                for (int i = 0; i < funcDefParamCount; i++) {
//                    if (!funcDefParamTypes.get(i).equals(funcCallParamTypes.get(i))) {
//                        errors.add(new Error(ident.getLineNumber(), "e"));
//                        break;
//                    }
//                }
//            }
...
//        if (!symbolTable.isExist(ident.getName(), SymbolType.FUNC)) {
