...
public class LeqIr extends IntermediateInstruction {
    public LeqIr(Operand oprandIdx1, Operand oprandIdx2, Operand resIdx) {
        super(oprandIdx1, oprandIdx2, resIdx);
    }

    public String toString() {
        return "Leq " + getLeft() + " " + getRight() + " " + getRes();
    }
    ...
    public List<MipsCode> toMips() {
        ...
        mipsCodes.add(new Sge(t1, t0, t2));
