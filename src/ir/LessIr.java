...
public class LessIr extends IntermediateInstruction {
    public LessIr(Operand oprandIdx1, Operand oprandIdx2, Operand resIdx) {
        super(oprandIdx1, oprandIdx2, resIdx);
    }

    public String toString() {
        return "Less " + getLeft() + " " + getRight() + " " + getRes();
    }
    ...
    public List<MipsCode> toMips() {
        ...
        mipsCodes.add(new Slt(t0, t1, t2));
